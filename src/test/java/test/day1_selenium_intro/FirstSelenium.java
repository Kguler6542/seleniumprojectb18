...
public class FirstSelenium {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //1- The below line creates the connection between driver and selenium. And sets up the driver.
              WebDriverManager.chromedriver().setup();

        //2- Creating the instance of ChromeDriver to be able to do action on ChromeBrowser
             WebDriver driver = new ChromeDriver();

        //The line below maximizes the browser page after opening it. //driver.manage().window().maximize();
        ...
        //3- we get google.com . // String googleUrl = "https://www.google.com";
        ...
        //Thread.sleep is being added just to be able to see selenium movements
            ...
            Thread.sleep(3000);
            driver.navigate().to("https://mobile.connect.myflorida.com/prweb/app/default/tHGV_g6FQZMSYakWUervaQ%28%28*/!STANDARD");
